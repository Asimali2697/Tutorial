...
select EmployeeID, OrderID, OrderDate, Freight from Orders as o
join Employees as E on E.EmployeeID = O.EmployeeID

select FirstName, OrderID, OrderDate, Freight from Orders as o
join Employees as E on o.EmployeeID = E.EmployeeID

select CompanyName, OrderID, OrderDate, Freight from Orders as o
join Shippers as s on o.CustomerID = S.c

select * from [Order Details] where OrderID = 10285

select * from [Order Details] where Discount > 0

select * from [Order Details] where Discount > 0.14
...
select OrderID, count(*) AS TotalAmount from [Order Details] where OrderID = 10285 group by OrderID

select OrderID, sum(UnitPrice * Quantity) as TotalAmount from [Order Details] where OrderID = 10248 group by OrderID
...
UPDATE Suppliers
SET ContactName = 'Zara Sheikh', ContactTitle = 'Sales Representative'
WHERE SupplierID = 3;
